...
const
  sUsage =
    '»спользование:'#9'%s <источник> [[<источник>...] [команды [параметры]]]';
  sHelp =
    ' оманды' + sLineBreak +
    ...
    'ѕараметры команд -extract и -into' + sLineBreak +
    ...
    'ѕараметры дл€ оценки размера и команды -into' + sLineBreak +
            #9'-3gb' +           #9#9#9'¬ключить большие адреса' + sLineBreak +
  ...
  sSectionNotFound = 'Section У%sФ not found';
